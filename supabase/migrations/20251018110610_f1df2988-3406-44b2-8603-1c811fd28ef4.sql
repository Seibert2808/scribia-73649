-- Fix scribia_create_palestra function to handle ENUM types correctly
...
BEGIN
  ...
  -- Inserir palestra com cast correto dos ENUMs
  INSERT INTO public.scribia_palestras (
    ...
    CASE WHEN p_formato_escolhido IS NULL THEN NULL ELSE p_formato_escolhido::formato_livebook END,
