...
import { Pencil, Trash2, Calendar, MapPin, Presentation, FileText } from "lucide-react";
            ...
            <div className="space-y-2 mt-4">
              <div className="flex gap-2">
                <Button
                  ...
                  size="sm"
                  className="flex-1"
                  onClick={() => navigate(`/eventos/${evento.id}/palestras`)}
                >
                ...
                <Button
                  ...
                  size="sm"
                  className="flex-1"
                  onClick={() => navigate(`/eventos/${evento.id}/livebooks`)}
                >
