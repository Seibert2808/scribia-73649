...
const OrganizadorSidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-purple-900 via-purple-800 to-blue-900 text-white shadow-xl z-40">
