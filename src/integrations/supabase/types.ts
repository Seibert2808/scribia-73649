...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      fiscalizacao_fiscalizacoes: {
        Row: {
          created_at: string
          cumprimento: string | null
          data_fiscalizacao: string
          data_verificacao_1: string | null
          data_verificacao_2: string | null
          id: string
          npf: string | null
          npj: string | null
          numero_designacao: string
          observacao: string | null
          pad_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "fiscalizacao_fiscalizacoes_pad_id_fkey"
            columns: ["pad_id"]
            isOneToOne: false
            referencedRelation: "fiscalizacao_pads"
      ...
      scribia_notificacoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "scribia_notificacoes_usuario_id_fkey"
            columns: ["usuario_id"]
            isOneToOne: false
            referencedRelation: "scribia_usuarios"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      scribia_get_notifications: {
        Args: { p_limit?: number; p_usuario_id: string }
        Returns: Json
      }
      ...
      scribia_mark_all_notifications_read: {
        Args: { p_usuario_id: string }
        Returns: Json
      }
      scribia_mark_notification_read: {
        Args: { p_notificacao_id: string; p_usuario_id: string }
        Returns: Json
      }
      ...
      scribia_set_user_role_and_event: {
        Args: {
          p_evento_associado?: string
      ...
      scribia_update_evento_associado: {
        Args: { p_evento_associado: string; p_user_id: string }
        Returns: Json
      }
